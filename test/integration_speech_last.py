...
#1. 구글 스토리지의 파일 리스트
files_gs_path = [(1,'gs://dlab_ml/speech/ref/샘플_1_개인정보삭제.wav', '2:04', 8000),
            (2, 'gs://dlab_ml/speech/ref/샘플_2_개인정보삭제.wav', '1:49', 8000),
            (3, 'gs://dlab_ml/speech/ref/샘플_3_개인정보삭제.wav', '1:29', 8000),
            (4, 'gs://dlab_ml/speech/ref/샘플_4_개인정보삭제.wav', '0.51', 8000),
            (5, 'gs://dlab_ml/speech/ref/샘플_5_개인정보삭제.wav', '1:42', 8000),
            (6, 'gs://dlab_ml/speech/ref/샘플_6_개인정보삭제.wav', '1:52', 8000),
            (7, 'gs://dlab_ml/speech/ref/샘플_7_개인정보삭제.wav', '1:02', 8000),
            (8, 'gs://dlab_ml/speech/ref/샘플_8_개인정보삭제.wav', '1:35', 8000),
            (9, 'gs://dlab_ml/speech/ref/샘플_9_개인정보삭제.wav', '2:20', 8000),
            (10, 'gs://dlab_ml/speech/ref/샘플_10_개인정보삭제.wav', '2:11', 8000),
            (11, 'gs://dlab_ml/speech/ref/샘플_11_개인정보삭제.wav', '2:30', 44100),
            (12, 'gs://dlab_ml/speech/ref/샘플_12_개인정보삭제.wav', '2:36', 44100),
            (13, 'gs://dlab_ml/speech/ref/샘플_13_개인정보삭제.wav', '2:20', 44100),
            (14, 'gs://dlab_ml/speech/ref/샘플_14_개인정보삭제.wav', '2:04', 44100)]
...
def excuteLongAudio():
    for (speech_num, file_gs_path, stream_time, sample_rate_hertz) in files_gs_path:
...
def executeMetaLongAudio():
    ...
    """
    interactionTypes = [(1, speech.enums.RecognitionMetadata.InteractionType.PHONE_CALL)]
    # 오디오 산업 카테고리

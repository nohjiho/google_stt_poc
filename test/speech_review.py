...
# 1. 구글 스토리지의 파일 리스트
files_gs_path = [(1, 'gs://dlab_ml/speech/ref/샘플_1_개인정보삭제.wav', '2:36')]

sample_rate_hertz = 8000  # 8000,44100
                    ...
                    for (originalMediaType_idx, originalMediaType) in originalMediaTypes:
                        for (recordingDeviceType_idx, recordingDeviceType) in recordingDeviceTypes:
                            ...
                            try:
                                ...
                                # 2-2. 긴 오디오 파일 인식 결과 가져오기
                                tuple_result_msg = beta_snippets.transcribe_gcs_with_metadata_return(file_gs_path,
                                                                                                     # 스토리지 uri
                                                                                                     sample_rate_hertz,
                                                                                                     # 샘플비율 헤르츠
                                                                                                     interactionType,
